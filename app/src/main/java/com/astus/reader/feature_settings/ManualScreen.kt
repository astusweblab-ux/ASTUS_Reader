        ...
        LazyColumn(
            ...
            item {
                ManualCard(
                    ...
                    body = "Во время чтения можно пролистать текст без смены озвучиваемого места. Чтобы выбрать новую строку или фразу для TTS, удерживайте ее примерно 1 секунду. После виброотклика озвучивание продолжится с выбранного места."
                )
            }
            item {
                ManualCard(
